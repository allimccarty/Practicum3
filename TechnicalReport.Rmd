...
**CV for multiple models - explain what I did and why**
...
set.seed(123)
formulas <- gen_formula <- function(picks,curfeatures = c("Month","Trout.Interp","Caloric","Land", "AmoebaNA")) {
...
#at least two 
possPicks = list(c(1, 2),c(1, 3),c(1, 4),c(1,5),c(2, 3),c(2, 4),c(2,5),c(3, 4),c(3,5),c(4,5),c(1, 2, 3),c(1, 2, 4),c(1, 3, 4),c(2, 3, 4),c(1,2,5),c(1,3,5),c(1, 2, 3, 4),c(1,2,3,5),c(1,2,3,4,5))
all_formulas = sapply(possPicks,formulas)
cv_scores = sapply(all_formulas, cv_model)
bestFormula = all_formulas[which.max(cv_scores)]
bestFormula
#otter.lm = lm(Activity ~ Month + Trout.Interp + Caloric + Land + AmoebaNA, data = model.dat)

```
**explain results - month and trout** 
