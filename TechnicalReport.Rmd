...
#Extrapolation for Month 0 and 20
otter$Trout.Interp[5] <- 174.80
```
...
- t.test for difference in means to prove no quantitative difference
- Anything more to do the comparison of before v after?
